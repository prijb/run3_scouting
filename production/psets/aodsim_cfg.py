...
# with command line options: step2 --mc --eventcontent AODSIM --datatier AODSIM --conditions 124X_mcRun3_2022_realistic_v12 --step RAW2DIGI,L1Reco,RECO,RECOSIM --procModifiers siPixelQualityRawToDigi --geometry DB:Extended --era Run3 --fileout file:output_aod.root --python_filename aod_cfg.py --filein file:output_raw.root --no_exec -n 5
